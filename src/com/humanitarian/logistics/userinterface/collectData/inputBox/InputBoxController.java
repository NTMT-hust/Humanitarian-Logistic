...
public class InputBoxController {
	...
	private String collectorType, function;

	public InputBoxController(Collector<?, ?, ?> collector, String collectorType, String function) {
	...
	public void submit(ActionEvent event) throws IOException {
		...
		loader.setControllerFactory(type -> {
			if (type == SearchingController.class) {
				return new SearchingController(collectorType, keyWord);
			}
