...
public class SearchingController {
	...
	public SearchingController(String apiName, String keyWord) {
	...
	public void searchProcedure(InputData inputData) {
		...
		if (apiName == "NewsAPI") {
			searchCriteria = new SearchCriteria.Builder()
		...
		collectTask.setOnFailed(event -> {
			...
			e.printStackTrace();
			loadNextScene("/com/humanitarian/logistics/userinterface/Error.fxml", "Error");
		});
	...
	private void savePost(List<SocialPost> newPosts) {
		...
		String fileName = "data/" + apiName.toLowerCase() + "/" + keyWord.toLowerCase() + "_posts.json";
